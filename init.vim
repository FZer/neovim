...
" 代码补全. ultisnips是snippets enginne，要配合honza/vim-snippets一起用. (UltiSnips also integrates with deoplete)
...
" There's a REPL in Fireplace. By the way, this plugin is for Clojure
...
let g:python3_host_prog="D:/Program/Python37/python.exe"
let g:python_host_prog="D:/Program/Python27/python2.exe"
